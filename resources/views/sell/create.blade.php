    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-8 offset-2 bg-white">
                ...
                <form method="get" action="{{ route('product.index') }}" class="p-5" enctype="multipart/form-data">
                    @csrf
                    ...
                    <span class="item-image-form image-picker">
                        ...
                        <label for="item-image" class="d-inline-block" role="button">
                            <img src="/images/default.jpeg" style="object-fit: cover; width: 300px; height: 300px;">
                        </label>
                    </span>
                    @error('item-image')
